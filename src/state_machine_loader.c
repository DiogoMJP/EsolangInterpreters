...
state_machine* create_state_machine_loader() {
	...
	#endif
	state_machine *sm_loader = create_state_machine(11);
	...
	transitions2[0] = t2_3;
	transitions2[1] = t2_6;
	add_state(sm_loader, 2, transitions2);
	...
	transitions3[0] = t3_4;
	add_state(sm_loader, 1, transitions3);
	...
	transitions5[0] = t5_2;
	transitions5[1] = t5_7;
	add_state(sm_loader, 2, transitions5);
	...
	transitions7[0] = t7_8;
	add_state(sm_loader, 1, transitions7);

	transition *t8_0 = create_transition("\n", 1, 0);
	transition *t8_8 = create_transition("0123456789", 10, 8);
	transition *t8_9 = create_transition(" \t", 2, 9);
	transition *t8_10 = create_transition(";", 1, 10);
	transition **transitions8 = (transition**) malloc(4 * sizeof(transition*));
	transitions8[0] = t8_0;
	transitions8[1] = t8_8;
	transitions8[2] = t8_9;
	transitions8[3] = t8_10;
	add_state(sm_loader, 4, transitions8);

	transition *t9_0 = create_transition("\n", 1, 0);
	transition *t9_9 = create_transition(" \t", 2, 9);
	transition *t9_10 = create_transition(";", 1, 10);
	transition **transitions9 = (transition**) malloc(3 * sizeof(transition*));
	transitions9[0] = t9_0;
	transitions9[1] = t9_9;
	transitions9[2] = t9_10;
	add_state(sm_loader, 3, transitions9);

	transition *t10_0 = create_transition("\n", 1, 0);
	transition *t10_10 = create_transition(
		" !\"#$\%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz~", 92, 10
	);
	transition **transitions10 = (transition**) malloc(2 * sizeof(transition*));
	transitions10[0] = t10_0;
	transitions10[1] = t10_10;
	add_state(sm_loader, 2, transitions10);
